...
import ForoAluraApi.domain.respuestas.RespuestaRepository;
import ForoAluraApi.domain.topicos.TopicoRepository;
...
public class TopicosController {
    ...
    public ResponseEntity<RespuestaTopico> registrarTopico(@RequestBody @Valid DatosRegistroTopico datosRegistroTopico,
        ...
        URI url = uriComponentsBuilder.path("/topico/{id}").buildAndExpand(topico.getId().toString()).toUri();
    ...
    public ResponseEntity<TopicoResp> registrarRespuesta(@PathVariable Long id,
        ...
        URI url = uriComponentsBuilder.path("/{id}/respuesta/{idResp}").buildAndExpand(topico.getId().toString(),
    ...
    @PutMapping("/{id}/respuesta/{idResp}")
    @Transactional
    ...
    @GetMapping("/{id}/respuesta/{idResp}")
    ...
    @DeleteMapping("/{id}/respuesta/{idResp}")
    @Transactional
